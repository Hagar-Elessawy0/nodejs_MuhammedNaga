...
function examplePromisesAll1() {
    ...
    const promise2 = new Promise((resolve, reject) => { setTimeout(resolve, 100, 'Value From Promise 2'); });
    return Promise.all([promise1, promise2]);
}
examplePromisesAll1().then(console.log).catch(console.error);
...
examplePromisesAll2().then(console.log).catch(console.error);
